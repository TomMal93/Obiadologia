...
| przygotowanie treści nowego przepisu | [recipe-template.md](content/recipe-template.md), zgodny z [data-model.md](engineering/data-model.md) |
...
- Każda główna sekcja wypełnia jeden ekran (jedna sekcja = jeden ekran), z wyjątkiem dokumentowej strony przepisu oraz sekcji Kategorii mieszczącej pięć pełnych kart wynikowych — [ui-system.md](design/ui-system.md), [home-page.md](product/features/home-page.md) i [recipe-page.md](product/features/recipe-page.md).
