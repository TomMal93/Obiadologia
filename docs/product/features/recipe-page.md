...
- Sekcja „Składniki” korzysta z tej samej neutralnej ramki co panel „O daniu” i sekcja „Przygotowanie”. Pod nagłówkiem sekcji, przy prawej krawędzi kolumny treści, stoi wyłącznie postęp odhaczania. Miara stoi przy prawej krawędzi wiersza składnika i pozostaje nierozdzielona; przy dłuższej nazwie łamie się nazwa, a nie miara.
