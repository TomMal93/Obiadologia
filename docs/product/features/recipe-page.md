...
| 11 | Składniki i kroki można niezależnie odhaczać. Akcja etapu ma dostępną nazwę zawierającą swój widoczny tekst oraz numer etapu. Wykonany etap pokazuje ✓ na osi i przekreśloną treść, a po ponownym rozwinięciu pozwala cofnąć wykonanie; wykonany półkrok pokazuje ✓ w checkboxie. Stan ukończenia jest widoczny nie tylko kolorem, nie zmienia danych i resetuje się po opuszczeniu strony. Licznik w wierszu nagłówka grup składników podaje aktualny postęp, zapełnia pasek postępu i po zebraniu wszystkiego pokazuje komplet. Bez skryptu kontrolki interakcji są ukryte, a obie listy pozostają kompletne i czytelne. |
