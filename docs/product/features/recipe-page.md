...
- Rozwinięta karta etapu pokazuje kolejno: przypisane półkroki pod nagłówkiem „Przygotuj przed wykonaniem” wraz z ich licznikiem, a pod linią rozdzielającą etykietę „Finalny krok”, treść kroku i wycentrowaną akcję „Oznacz jako zrobione” z pustym okręgiem. Nagłówek półkroków, ich licznik i etykieta „Finalny krok” należą wyłącznie do etapu z półkrokami. Numer etapu niesie wyłącznie znacznik osi — karta go nie powtarza: ani widoczną etykietą „Etap {numer}”, ani znacznikiem przy finalnym kroku. Etykieta „Etap {numer}” pozostaje dostępną nazwą kontrolek etapu, niewidoczną na ekranie.
- Kliknięcie akcji oznacza etap jako wykonany: znacznik na osi zamienia numer na ✓, treść kroku zostaje przekreślona, karta zwija się do samej zapowiedzi treści, a ścieżka rozwija pierwszy etap wciąż do zrobienia. Ponowne rozwinięcie wykonanego etapu pokazuje akcję w stanie „Zrobione”, której kliknięcie cofa wykonanie i zostawia etap rozwinięty. Krok nie jest usuwany, a stan nie jest zapisywany między wizytami. Bez skryptu strona pokazuje semantyczną listę `ol` z pełną treścią każdego etapu, bez zwijania, akcji i liczników.
