...
- Każdy krok można lokalnie oznaczyć jako wykonany. Sekcja zapowiada tę interakcję instrukcją, a każdy aktywny krok pokazuje podpis akcji. Po odhaczeniu krok minimalizuje się do zwartego wiersza „Krok {numer} wykonany” ze znacznikiem ✓ i jednoliniowym fragmentem oryginalnej treści zapisanym mniejszą, przygaszoną czcionką; nie pokazuje dodatkowego podpisu przywracania, ale ponowne kliknięcie całej karty przywraca pełną treść. Krok nie jest usuwany ani przekreślany i nie przechodzi automatycznie dalej. Stan nie jest zapisywany między wizytami. Bez skryptu instrukcja i podpisy akcji pozostają ukryte, a strona pokazuje semantyczną listę `ol` bez kontrolek ukończenia.
...
- Etykiety „Przygotowanie” i „Gotowanie” porządkują oba etapy przepływu. Półkroki i krok gotowania, do którego prowadzą, tworzą jedną obramowaną grupę z ciągłym koralowym akcentem; półkroki mają lżejsze tło, checkbox i etykietę wskazującą numer docelowego kroku. Każdy właściwy krok gotowania ma numer, tekst i widoczną akcję „Zrobione” stylizowaną jak przycisk; stan wykonany minimalizuje powierzchnię, zmienia numer na ✓ i ogranicza treść do jednoliniowego fragmentu mniejszą czcionką, bez dodatkowego podpisu akcji.
