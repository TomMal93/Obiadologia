...
- Etykiety „Przygotowanie” i „Gotowanie” porządkują oba etapy przepływu. Kroki gotowania mają postać ścieżki: oś z okrągłymi znacznikami przy lewej krawędzi i karty etapów obok niej. Znaczniki niosą przebytą drogę także wielkością: etap jeszcze do zrobienia ma mniejsze, jasne kółko z numerem, bieżący jest największy — ma grubsze koralowe obramowanie, koralowy numer i otaczający go jasny pierścień — a wykonany koralowe wypełnienie ze znakiem ✓ w pełnym rozmiarze. Wszystkie znaczniki są wyśrodkowane na wierszu sterowania własną kartą. Oś jest koralowa aż do znacznika pierwszego etapu do zrobienia, czyli także na odcinku etapu bieżącego; dalszy odcinek pozostaje jasny. Rozwinięta karta ma delikatnie koralowe tło i koralowe obramowanie, zwinięta zostaje jasna i neutralna. Zwinięty wiersz mieści jednoliniową, przyciętą zapowiedź treści i strzałkę stanu, bez powtórzonego numeru etapu. Wewnątrz karty półkroki mają checkboxy i własny nagłówek, a finalny krok samą treść — bez znacznika z numerem — i wycentrowaną akcję w kształcie pigułki z pustym okręgiem; pełne koralowe wypełnienie z ✓ komunikuje stan wykonany.
