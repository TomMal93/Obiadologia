...
- Na pierwszym ekranie strony głównej nagłówek ma stałą kotwicę pionową, a panel dróg jest dosuwany do dolnej kotwicy sekcji. Wysokość panelu wynika z responsywnie skalowanej zawartości, dlatego na wyższym ekranie jego górna krawędź obniża się zamiast podnosić dolną krawędź ramki. Dolna krawędź notatki zachowuje stały odstęp od ramki panelu. Odstęp drzewa od siatki dróg jest stały i skalibrowany dla Pixel 7 (`412 × 839px`). Lokalną geometrię grupy akcji definiuje [home-page.md](../product/features/home-page.md).
...
| geometria pierwszego ekranu | nagłówek główny nie zmienia położenia pionowego; panel dróg jest dosuwany do dolnej kotwicy sekcji, a jego górna krawędź obniża się stosownie do dostępnego miejsca; wysokość panelu dopasowuje się do zawartości, a odstępy notatki od ramki panelu oraz drzewa od siatki dróg pozostają stałe między mobilnymi viewportami; referencje: iPhone 12 Pro (`390 × 844px`) i Pixel 7 (`412 × 839px`); lokalna geometria grupy akcji jest w [home-page.md](../product/features/home-page.md) |
