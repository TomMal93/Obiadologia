...
| TD-008 | Cała karta jest linkiem do `/recipes/:slug`. Do czasu implementacji strony przepisu trasa pokazuje ekran zastępczy. | Zachowujemy docelowy kontrakt nawigacji bez rozszerzania etapu; zakres trasy definiuje [mvp-scope.md](../product/mvp-scope.md). |
