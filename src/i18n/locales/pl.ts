export const pl = {
  ...
  recipe: {
    ...
    preparationHint: 'Sprawdź, co możesz mieć gotowe wcześniej, a co zrobić na świeżo.',
    preparationTiming: {
    ...
    preparationStepLabel: 'Do zrobienia',
    preparationStepCompleteLabel: 'Gotowe',
    preparationActionHint: 'Dotknij, gdy gotowe',
    preparationActionComplete: 'Dotknij, aby przywrócić',
    stepsStageLabel: 'Gotowanie',
    stepsHeading: 'Kroki',
    stepsInteractionHint: 'Dotknij kroku, aby oznaczyć go jako wykonany.',
    stepActionPending: 'Dotknij, aby odhaczyć',
    stepCompleteLabel: 'Krok {number} wykonany',
    stepActionComplete: 'Dotknij, aby przywrócić',
